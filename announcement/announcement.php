...
<br>
<form action="ann_submit.php?code=<?php echo $current_class_code ?>" method="post" enctype="multipart/form-data">

<div class="form-group">
<textarea class="form-control" rows="4" cols="50" name="ann" id="ann" placeholder="Add Announcement" required></textarea>
</div>
<br>
